...
downloadBtn.addEventListener("click", () => {
    let resumePath =
        "https://drive.google.com/file/d/19JbJEkHoyDX_gkxOZcs7Jj4LRpuNHFCV/view?usp=drive_link";
...
function sendEmail() {
    ...
    Email.send({
        ...
        Username: "yritik737@gmail.com",
        Password: "09F485E5249872C53B409AA7AD69D649CDE9",
        To: "yritik737@gmail.com",
        From: "yritik737@gmail.com",
        Subject: sub.value,
        Body: bodyMesg,
    }).then((message) =>
